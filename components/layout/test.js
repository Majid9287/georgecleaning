      ...
      try {
        ...
        if (data && data.services && data.services.length > 0) {
          setMenuItems((prevMenuItems) => {
            ...
            const servicesIndex = updatedMenuItems.findIndex(
            ...
            if (servicesIndex !== -1) {
              ...
              const existingSublinks =
                updatedMenuItems[servicesIndex].sublinks || [];
        ...
        setServicesSublinksFetched(true); // Set fetched flag regardless of data validity
      } catch (error) {
        if (error.name === "TypeError") {
          console.error("Network error fetching Services sublinks:", error);
        } else {
          console.error("Unexpected error fetching Services sublinks:", error);
        }
      }
    };
